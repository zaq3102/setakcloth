    ...
    <div className="wrap">
      <div className="banner">
        ...
        <div className="banner-title-1">
          <div className="catchprize">투명하게, 편리하게, 공정하게</div>
          <div className="catchprize-main">세탁클로쓰, 지금 시작하세요!</div>
        </div>
      </div>
      ...
      <div className="mockups">
        ...
        <div className="mockup-end">
          <div className="mockup-title">
            <div className="mockup-title-head1">편리한 수거, 배달</div>
            <div className="mockup-title-body1">
              문 앞에서 끝내는 세탁소 방문
              <br />
              직접 가지 않아도 돼요.
            </div>
        ...
        <div className="mockup-end">
          <div className="mockup-title">
            <div className="mockup-title-head1">
              궁금했던 세탁소 정보
              <br />
              한눈에
            </div>
